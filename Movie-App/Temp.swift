    ...
    var body: some View {
        NavigationView {
            List {
                ...
                .onDelete(perform: viewModel.deleteMovieItems)
            }
            .toolbar {
                ...
                ToolbarItem {
                    Button(action: viewModel.addMovieItem) {
...
struct Temp_Previews: PreviewProvider {
    static var previews: some View {
        Temp().environment(\.managedObjectContext, PersistenceController.preview.container.viewContext)
    }
}
